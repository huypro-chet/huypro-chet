...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/template/admin/theme-assets/vendors/css/charts/chartist.css'/>">
    <!-- END VENDOR CSS-->
    <!-- BEGIN CHAMELEON  CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/template/admin/theme-assets/css/pages/dashboard-ecommerce.css'/>">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <!-- END Custom CSS-->
  </head>
          ...
          <div class="collapse navbar-collapse show" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-19.png'/>" alt="avatar"><i></i></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-19.png'/>" alt="avatar"><span class="user-name text-bold-700 ml-1">John Doe</span></span></a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="<c:url value='/template/admin/theme-assets/images/backgrounds/02.jpg'/>">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="Chameleon admin logo" src="<c:url value='/template/admin/theme-assets/images/logo/logo.png'/>"/>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="active"><a href="admin"><i class="ft-home"></i><span class="menu-title" data-i18n="">HOME</span></a>
          </li>
          ...
          <li class=" nav-item"><a href="Tab.jsp"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="">SUM LIKE</span></a>
          </li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <span class="avatar">
                            <img src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-2.png'/>" alt="avatar">
                        </span>
                        <span class="avatar">
                            <img src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-3.png'/>" alt="avatar">
                        </span>
                        <span class="avatar">
                            <img src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-4.png'/>" alt="avatar">
                        </span>
                    </div>
                </div>
                ...
                <div id="carousel-area" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="<c:url value='/template/admin/theme-assets/images/carousel/08.jpg'/>" class="d-block w-100" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img src="<c:url value='/template/admin/theme-assets/images/carousel/03.jpg'/>" class="d-block w-100" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="<c:url value='/template/admin/theme-assets/images/carousel/01.jpg'/>" class="d-block w-100" alt="Third slide">
                        </div>
                    </div>
            ...
            <div class="card-content">
                <div id="recent-buyers" class="media-list">
                    <a href="#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object rounded-circle" src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-7.png'/>" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                            ...
                            <ul class="list-unstyled users-list m-0 float-right">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 1" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<c:url value='/template/admin/theme-assets/images/portfolio/portfolio-1.jpg'/>"
                                        alt="Avatar">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<c:url value='/template/admin/theme-assets/images/portfolio/portfolio-2.jpg'/>"
                                        alt="Avatar">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 3" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<c:url value='/template/admin/theme-assets/images/portfolio/portfolio-4.jpg'/>"
                                        alt="Avatar">
                                </li>
                            </ul>
                    ...
                    <a href="#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-away">
                                <img class="media-object rounded-circle" src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-8.png'/>" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                            ...
                            <ul class="list-unstyled users-list m-0 float-right">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 1" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<c:url value='/template/admin/theme-assets/images/portfolio/portfolio-5.jpg'/>"
                                        alt="Avatar">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<c:url value='/template/admin/theme-assets/images/portfolio/portfolio-6.jpg'/>"
                                        alt="Avatar">
                                </li>
                            </ul>
                            <p class="list-group-item-text mb-0">
                    ...
                    <a href="#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-busy">
                                <img class="media-object rounded-circle" src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-9.png'/>" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                    ...
                    <a href="#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object rounded-circle" src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-10.png'/>" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                    ...
                    <a href="#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object rounded-circle" src="<c:url value='/template/admin/theme-assets/images/portrait/small/avatar-s-11.png'/>" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
...
<!--/ Statistics -->
    ...
    <script src="<c:url value='/template/admin/theme-assets/vendors/js/charts/chartist.min.js'/>" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN CHAMELEON  JS-->
    ...
    <!-- END CHAMELEON  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<c:url value='/template/admin/theme-assets/js/scripts/pages/dashboard-lite.js'/>" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>