	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-content collapse show">
				<div class="card-body">
					<p class="card-text">Bảng <code>.Thống kê</code>số lượt like</p>
				</div>
				<div class="table-responsive">
					<table class="table table-bordered mb-0">
						...
						<c:forEach items="${sanphams}" var="sanphams">
							<tr scope="row">
								<td>${sanphams.tenspid}</td>
								<td>${sanphams.tensp}</td>
								<td><a href="videoct?action=like&id=${sanpham.codelink}">${sanphams.codelink}</a></td>
								<td>${sanphams.totarlike}</td>
							</tr>
							</c:forEach>
						</tbody>
					</table>
